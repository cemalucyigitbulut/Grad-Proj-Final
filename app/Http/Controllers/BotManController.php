    ...
    // });
        ...
        // });
           ...
           //-----------------------------------------------E
            ...
            $botman->reply('You can use this link to go to the Register page <br> Register Link <a href="http://127.0.0.1:8000/register" onclick="window.open(this.href,\'_blank\');return false;" >Here</a>.');
        });

            $botman->hears('Login|login',function($botman){
            $botman->reply('You can use this link to go to the Login page <br> Login Link <a href="http://127.0.0.1:8000/login" onclick="window.open(this.href,\'_blank\');return false;">Here</a>.');
            //$botman->reply('You can use this link to go to the Login page <br> Login Link <a href="http://127.0.0.1:8000/login" onclick="" >Here</a>.');
        });


            $botman->hears('Property|property',function($botman){
            $botman->reply('Here are the results I found for the keyword Property/property <br> Properties Link <a href="http://127.0.0.1:8000/search?address=&category=&bedrooms=&max=&min=" onclick="window.open(this.href,\'_blank\');return false;" >Here</a>.');
        });

            $botman->hears('Properties|properties',function($botman){
            $botman->reply('Here are the results I found for the keyword Properties/properties <br> Properties Link <a href="http://127.0.0.1:8000/search?address=&category=&bedrooms=&max=&min=" onclick="window.open(this.href,\'_blank\');return false;" >Here</a>.');
        });

            $botman->hears('Chat|chat',function($botman){
            $botman->reply('Following this link, you can chat with any user <br>  <a href="http://127.0.0.1:8000/chatify" onclick="window.open(this.href,\'_blank\');return false;" >Click here</a>.');
        });

             $botman->hears('Favorite|favorite',function($botman){
            $botman->reply('Following this link, you can find your favorite property/properties <br>  <a href="http://127.0.0.1:8000/home" onclick="window.open(this.href,\'_blank\');return false;" >Click here</a>.');
        });
           //-----------------------------------------------S
